                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        <div class="card card-signup">
                            <form class="form" method="post" action="<?=base_url('user/list_property')?>">
                                ...
                                <div class="content">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="property_type" class="form-control" placeholder="Property Type" required>
                                        <p class="help-block" style="color: #960004 "><?=form_error('property_type','<div class="help-block" style="color: red ">', '</div>')?></p>
                                    </div><br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <p class="help-block" style="color: #960004 "><?=form_error('city','<div class="help-block" style="color: red ">', '</div>')?></p>
                                    </div><br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="property_date" class="form-control" placeholder="Property Date..."  >
                                    </div><br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <p class="help-block" style="color: #960004 "><?=form_error('area','<div class="help-block" style="color: red ">', '</div>')?></p>
                                    </div><br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <p class="help-block" style="color: #960004 "><?=form_error('price','<div class="help-block" style="color: red ">', '</div>')?></p>
                                    </div><br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <p class="help-block" style="color: #960004 "><?=form_error('property_address','<div class="help-block" style="color: red ">', '</div>')?></p>
                                    </div><br>
